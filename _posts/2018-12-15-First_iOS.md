...
fuctions窗口搜索 callWebAPI:data:method:ssl:completionHandler: 找到 [WebService callWebAPI:data:method:ssl:completionHandler:]，找到data关键加密信息，接着搜索setValue:forKey
...
因为APP使用的是RSA加密，这也就证明了CC_hook.js hook为什么不到了。关键来了convertToJsonData，然后iBuickAppPrivate，进去
